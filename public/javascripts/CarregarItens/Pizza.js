...
async function carregarItensCardapio(categoriaSelecionada = "Romance") {
  const listaCardapio = document.getElementById("lista-Pizzas");
      ...
      if (item && item.categoria === categoriaSelecionada) {
        ...
        div.innerHTML = `
                    ...
                    <div class="content">
                        ...
                        <div class="card-price">R$ ${item.preco.toFixed(
                          2
                        )}</div>
                    </div>
                    <div>
                        <input 
                            ...
                            onchange="adicionarAoCarrinho('${item.nome}', ${
          item.preco
        }, '${item.imagem}', this.value)">
                    </div>
